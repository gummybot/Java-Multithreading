package com.gummybot.multithreading.restaurantexample.withoutsync;
...
public class ClassRestaurantExample {
    ...
    //without synchronization threads will be executed in parallel and give inconsistent output
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Process ran total for " + (System.currentTimeMillis() - startTime) + " millisec");
    }
}
